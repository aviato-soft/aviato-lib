...
var aviato = {
	fn: {
		 ...
		 */
		arrayMap: function (arNames, arValues) {
			var oReturn = {};
			var i;
		 ...
		 */
		formToLocalStorage: function (selector) {
		 ...
		 */
		localStorageToForm:function (selector) {
	...
	bootstrap: {
		 ...
		 **/
		isXs: function () { // require navbar to return correct result
	 ...
	 *  * @author Vasile Giorgi
	 */
		showCollapseByLocationHash: function (parentId, closeOthers) {
	 ...
	 * @author Vasile Giorgi
	 */
		addCollapseItem: function (oItemProperties, bAppendToParent) {
...
aviato.fn.prototype.test = function(x) {alert (x)};
